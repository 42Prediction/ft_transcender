...
export class AddCommissionTransactionType1783503491161 implements MigrationInterface {
    name = 'AddCommissionTransactionType1783503491161'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."transaction_type_enum" RENAME TO "transaction_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."transaction_type_enum" AS ENUM('DEPOSIT', 'WITHDRAW', 'BET', 'PAYOUT', 'COMMISSION')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."transaction_type_enum_old" AS ENUM('DEPOSIT', 'WITHDRAW', 'BET', 'PAYOUT')`);
